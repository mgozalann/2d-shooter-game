...
public class PlayerAnimations : MonoBehaviour
{
    ...
    private void ApplyTilt() {
        ...
        Quaternion targetHatRotation =
            Quaternion.Euler(currentHatRotation.eulerAngles.x, currentHatRotation.eulerAngles.y, -targetAngle / _cowboyBoyHatTiltModifer);

        _cowboyHatTransform.rotation =
            Quaternion.Lerp(currentHatRotation, targetHatRotation, _tiltSpeed * _cowboyBoyHatTiltModifer * Time.deltaTime);
    }
}
